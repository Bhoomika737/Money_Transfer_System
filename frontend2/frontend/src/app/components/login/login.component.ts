...
export class LoginComponent implements OnInit {
  ...
  // Must include letters, numbers, special char, min 8 chars
  ...
  login() {
    ...
    if (!this.passwordPattern.test(this.password)) {
      this.errorMessage = 'Password must include letters, numbers, a special symbol, and be at least 8 characters long';
      return;
    }
